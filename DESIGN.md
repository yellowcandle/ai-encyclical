...
- **Display ZH** (700 weight, `clamp(1.7rem, 3vw + 0.6rem, 2.4rem)`, Noto Serif TC): the masthead Chinese title (`「偉大的人類」通諭`, the official Vatican News rendering). Sits beneath the English display title at proportionally smaller scale per the source-language hierarchy. Also fluid; preserves the ~1.42 EN:ZH display ratio at all viewport widths.
